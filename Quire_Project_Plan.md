...
- Stored at `%AppData%\Quire\buffer.json` — completely separate from `History.md`
...
- [ ] Uninstall leaves no orphaned files outside `%AppData%\Quire`
